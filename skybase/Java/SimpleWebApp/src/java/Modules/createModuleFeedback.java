...
@WebServlet(urlPatterns = {"/createModuleFeedback"})
public class createModuleFeedback extends HttpServlet{
    
    private static final long serialVersionUID = 1L;
    
    public createModuleFeedback(){
        super();
    }
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/createModuleFeedbackView.jsp");
    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
       ...
       if(errorString != null){
           ...
           RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/WEB-INF/views/createModuleFeedbackView.jsp");
           dispatcher.forward(request, response);
       }
       else{
