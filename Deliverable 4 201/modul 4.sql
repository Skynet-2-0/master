...
(2, 'Kode', 'Java', 'Læreboka kap2'),
(3, 'Hacke Skynet konkurrenter', 'Bli en hacker', 'www.Hackerschool.com'),
(4, 'Hacke uten å bli tatt', 'Hvordan man holder seg unna fengsel', 'www.Hackerschool.com'),
(5, 'grunnleggende koding', 'Koding basics', 'Læreboka kap 2'),
(6, 'viderekommen koding', 'Koding med loops', 'Læreboka kap 3 og 4'),
(7, 'teste klasser', 'bugs og tester', 'Læreboka kap 6'),
(8, 'planlegge prosjekter', 'planlegging', 'Læreboka kap2');
...
VALUES
 ...
 (420, 'Brage Fosso', 'PDF', 2010, 150, 5, 2);
